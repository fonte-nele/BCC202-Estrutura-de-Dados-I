#ifndef PRATICA07QUESTAO2_H
#define PRATICA07QUESTAO2_H
#include<iostream>
#include<ctime>
using namespace std;
...
void HeapRefaz(TNumero*,int,int,int*,int*);
void HeapConstroi(TNumero*,int,int*,int*);
void HeapSort(TNumero*,int,int*,int*);
