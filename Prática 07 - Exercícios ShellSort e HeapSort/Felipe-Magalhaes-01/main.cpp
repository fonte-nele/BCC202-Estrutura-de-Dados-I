...
int main()
{
	...
	cout<<"  || BubbleSort, SelectionSort, InsertionSort, MergeSort, QuickSort e ShellSort na qual       ||"<<endl;
	cout<<"  || pergunta-se ao usuario a quantidade de vetores desejado e faz a ordenacao dos mesmos.    ||"<<endl;
	cout<<"   ============================================================================================ "<<endl<<endl;
	
	int i,j,num_vetores,quant,vetor_comp[7],vetor_mov[7],temp,comp=0;
	
	TNumero* vetor,*aux;
	
	clock_t inicio1,fim1,total1,inicio2,fim2,total2,inicio3,fim3,total3;
	...
	for(i=0;i<num_vetores;i++)
	{
		...
		inicio3=clock();
		ShellSort03(vetor,quant,vetor_comp,vetor_mov);
		cout<<"\n - - Shell03...: ";
		Imprimir(vetor,temp);
		fim3=clock();
		total3=fim3-inicio3;
