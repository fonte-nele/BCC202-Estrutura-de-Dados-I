...
int main()
{
	...
	cout<<"  || Iniciar uma lista, verificar se a lista esta vazia, inserir um item no inicio ou final da lista  ||"<<endl;
	cout<<"  || Retirar um item no inicio ou final da lista e imprimir dados da lista.                           ||"<<endl;
	cout<<"   ==================================================================================================== "<<endl<<endl;
	...
	do{
		...
		switch(op)
		{
			...
			case 6:
			{
				...
				{
					cout<<"\n\nFOI RETIRADO O ULTIMO ITEM DA LISTA..."<<endl;
